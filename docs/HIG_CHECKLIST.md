...
- Use `NavigationSplitView` for the thread sidebar, conversation, and optional workbench inspector.
- Preserve selection across column changes and hide the inspector before collapsing the primary navigation.
