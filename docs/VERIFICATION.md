...
- Intermittent host SIGSEGV failures were observed on Darwin during command probes. One-shot polling contained a statically confirmed use-after-free and unsynchronized retirement; these were repaired, but a causal crash stack and repeated runtime results are still needed. A later successful run does not waive the earlier crashes.
